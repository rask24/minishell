...
/*   Updated: 2024/09/14 21:06:27 by reasuke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_ast_node_type	_convert_token_to_node(t_token_type token_type)
{
...
t_ast	*parse_list(t_token_list **cur_token)
{
	...
	{
		node_type = _convert_token_to_node(get_token_type(*cur_token));
